...
public class ListRotasActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent cadastroRotas = new Intent(ListRotasActivity.this, MenuuActivity.class);
    ...
    public void loadRotas() {
        if (isConnected())
            new ListRotasActivity.DownloadFromMyAPI().execute();
        else
    ...
    private class DownloadFromMyAPI extends AsyncTask<Void, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            progress = new ProgressDialog(ListRotasActivity.this);
        ...
        protected void onPostExecute(String s) {
            ...
            if (rotases != null) {
                ArrayAdapter<Rotas> rotasAdapter = new RotasAdapter(ListRotasActivity.this, R.layout.rotas_item, rotases);
                ListView listaRotas = (ListView) findViewById(R.id.listaRotas);
