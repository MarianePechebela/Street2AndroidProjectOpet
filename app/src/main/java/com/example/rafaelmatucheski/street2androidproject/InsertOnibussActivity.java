...
public class InsertOnibussActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_insert_onibuss);
    ...
    public void cadastrarOnibus(View v){
        ...
        if(isConnected())
            new InsertOnibussActivity.UploadToMyAPI().execute(onibuss);
        else
    ...
    private class UploadToMyAPI extends AsyncTask<Onibus, Void, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            if(Util.getStatusFromJSON(serverResponseMessage).equals("1")) {
                Toast.makeText(InsertOnibussActivity.this, "Onibus registrado com sucesso no sistema!", Toast.LENGTH_SHORT).show();
                listaOnibus = new Intent(InsertOnibussActivity.this, MenuuActivity.class);
                startActivity(listaOnibus);
            }else{
                Toast.makeText(InsertOnibussActivity.this, "Falha ao cadastrar o Onibus.", Toast.LENGTH_SHORT).show();
            }
        }
    }
